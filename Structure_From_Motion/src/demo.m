...
for curImage = 3 : 6
    ...
    % find correspondence which has been estimated 3D position in previous
    % image frames
    ...
    %% use those 3D information to implement PnP so that estimate current camera
    % pose (linear and nonlinear PnP)
    ...
    %% estimate new correspondences
    % the best way is traversing all previous image frames to get new
    % correspondences
